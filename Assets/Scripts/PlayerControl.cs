...
public class PlayerControl : MonoBehaviour
{
    ...
    private void FiringAnimationControl(Vector3 _direction)
    {
        ...
        else
        {
            ...
            //rend.sprite = Resources.Load<Sprite>("Shuriken_2_0000_0");
            // animator = rend.gameObject.AddComponent<Animator>();
            // animator.runtimeAnimatorController = Resources.Load<RuntimeAnimatorController>("Shuriken");
        }
    }
    ...
    private void Init()
    {
        ...
        else
        {
            ...
            var prefab = Resources.Load<GameObject>("shuriken");
